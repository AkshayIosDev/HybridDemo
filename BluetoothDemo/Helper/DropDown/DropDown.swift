    ...
    var searchText = String() {
        didSet{
            if searchText == "" {
                ...
                self.dataArray = dataList.filter {
...
//        self.layer.borderColor = UIColor(red:0.31, green:0.35, blue:0.46, alpha:0.2).cgColor
//        self.layer.cornerRadius = 12
//        self.layer.masksToBounds = true
//        self.font = UIFont(name: FontCustom.Avenir.medium, size: 16)
...
//    public func setAttributedPlaceholderWith(string: String) {
//        self.attributedPlaceholder = NSAttributedString(string:string, attributes:[NSAttributedString.Key.foregroundColor:  UIColor.TextFieldPlaceholderColor, NSAttributedString.Key.font : UIFont.PrimaryFonts.semiBold.of(size: 14)])
//
//    }
...
extension DropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.textLabel?.font = UIFont(name: FontCustom.Inter.medium, size: 14)
...
extension DropDown: UITableViewDelegate {
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let selected = dataList.firstIndex(where: {$0 == selectedText}) {
...
class Arrow: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        // Get size
//        let size = self.layer.frame.width   // uncomment this for arrow in dropdown
        let size = 0
